...
ALLOWED_HOSTS = [os.environ['WEBSITE_HOSTNAME'], '169.254.129.14'] if 'WEBSITE_HOSTNAME' in os.environ else []
...
STATIC_URL = 'static/'
STATICFILES_STORAGE = 'qpp.storage.WhiteNoiseStaticFilesStorage'
